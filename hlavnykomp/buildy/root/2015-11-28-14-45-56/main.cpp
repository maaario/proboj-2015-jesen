...
void zistiTah(){
    ...
    if((stav.hraci[0].obj.pozicia.x + 500) > (mapa.w)){
        getDirection(180);
        cerr << "dosiel som 1" << endl;
    }
    if((stav.hraci[0].obj.pozicia.y + 500) > (mapa.h)){
        getDirection(270);
        cerr << "dosiel som 2" << endl;
    }
    if((stav.hraci[0].obj.pozicia.y - 500) < 0){
        getDirection(90);
        cerr << "smer " << smer.y << endl;
    }
    if((stav.hraci[0].obj.pozicia.x - 500) < 0){
        getDirection(360);
    }
    else {
        direction();
